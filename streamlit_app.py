...
if not filtered_aggregated_data.empty:
   ...
   col1.metric("Total Sales ($)", round(total_sales_subcat, 0))
   col2.metric("Total Profit ($)", round(total_profit_subcat, 0))
   col3.metric("Overall Profit Margin (%)", round(profit_margin_subcat, 0))
else:
   ...
   col1.metric("Total Sales ($)", round(total_sales_cat, 0))
   col2.metric("Total Profit ($)", round(total_profit_cat, 0))
   col3.metric("Overall Profit Margin (%)", round(profit_margin_cat, 0))