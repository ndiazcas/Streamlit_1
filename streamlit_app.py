...
if not filtered_aggregated_data.empty:
   ...
   col3.metric("Overall Profit Margin (%)", round(profit_margin_subcat, 1), delta = round(delta_subcat, 2))
else:
   ...
   col3.metric("Overall Profit Margin (%)", round(profit_margin_cat, 1), delta = round(delta_cat, 2))