...
if not filtered_aggregated_data.empty:
   ...
   col3.metric("Overall Profit Margin (%)", round(profit_margin_subcat, 2), delta = delta_subcat)
else:
   ...
   col3.metric("Overall Profit Margin (%)", round(profit_margin_cat, 2), delta = delta_cat)